...
abstract class REST_Controller extends \CI_Controller {
    ...
    protected function toresponse($status, $message, $date, $data, $conf = [])
    {
        $arr = [];
        $arr['Respon_status'] = $status;
        $arr['Respon_message'] = $message;
        $arr['Respon_date'] = $date;
        $arr['Respon_data'] = $data;
        
        if(count($conf) != null){
            $arr['Respon_config'] = $conf;
        }
