...
<div class="card card-custom gutter-b">
	...
	<form method="POST" action="<?php echo e(base_url()); ?>bookings/store" enctype="multipart/form-data" id="form-select">
		...
		<div class="card-body row">
			...
			$ci = &get_instance();
			?>
			<?php if($ci->config->item('kode_perush') == '01'): ?>
			<div class="col-md-3">
				<label>Cabang
					<span class="text-danger">*</span>
				</label>

				<select class="form-control <?php if(form_error('id_cabang')!=null): ?> is-invalid <?php endif; ?>" id="id_cabang" name="id_cabang" required>
					<option value="">-- Pilih Cabang --</option>
					<option value="1">Surabaya Utama</option>
					<option value="2">Surabaya Madya</option>
					<option value="3">Trans Jawa</option>
				</select>

				<label class="text-danger"><?php echo form_error('id_cabang'); ?></label>
			</div>
			<?php endif; ?>
			...
			<div class="col-md-9">
				...
				<table class="table table-responsive">
					<tr>
						...
						<td>
							<label><input type="checkbox" name="asuransi" value="1" id="asuransi"> Asuransi
							</label>

							<label class="text-danger"><?php echo form_error('asuransi'); ?></label>
						</td>
						<td>
							<label><input type="checkbox" name="packing" value="1" id="packing"> Packing</label>
...
<?php echo $__env->make("metronic.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\trans\application\views/metronic/create-booking.blade.php ENDPATH**/ ?>