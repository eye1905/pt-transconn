	...
	$('#show_all').DataTable({
		...
		{"render": function ( data, type, row )
			...
			var html = '<div class="btn-group"><button type="button" class="btn btn-sm btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button><div class="dropdown-menu">';
				...
				if((row.id_bookingstatus >=3 && row.id_bookingstatus <5) && a_pickup==true){
				...
				if((row.id_bookingstatus ==7 || row.id_bookingstatus ==5) && a_reschedule==true){
...
<?php /**PATH D:\xampp\htdocs\aplikasi-booking-lsj\application\views/metronic/stt/js-stt.blade.php ENDPATH**/ ?>