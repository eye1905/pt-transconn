<div class="card card-custom">
	<div class="card-header card-header-tabs-line">
		...
		<div class="card-toolbar">
			<a href="<?php echo e(base_url().get_instance()->uri->segment(1)); ?>" class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="top" title="Kembali">
	...
	<div class="card-body">
		<div class="tab-content">
			<div class="tab-pane active show" id="kt_tab_pane_1_4" role="tabpanel" aria-labelledby="kt_tab_pane_1_4">
				<div class="text-right">
					<?php if(get_instance()->Rolemenumodel->checkuri("bookings/update") and get_instance()->session->userdata('role') < 3): ?>
					<button type="button" id="btn-edit" onclick="goEdit()" class="btn btn-sm btn-warning mr-2" data-toggle="tooltip" data-placement="top" title="Edit Data">
				...
				<hr>
				<form method="POST" action="<?php if($data->id_bookingstatus==1): ?><?php echo e(base_url()."bookings/take/".$data->id_bookingorder); ?><?php else: ?><?php echo e(base_url()."bookings/update/".$data->id_bookingorder); ?><?php endif; ?>" enctype="multipart/form-data" id="form-select">
					...
					<div class="row">
						...
						<div class="col-md-3">
							...
							<input type="number" step="any" minlength="11" maxlength="13" placeholder="masukan telp pengirim"  class="form-control <?php if(form_error('nohp_pengirim')!=null): ?> is-invalid <?php endif; ?>" id="nohp_pengirim" name="nohp_pengirim" value="<?php if(set_value("nohp_pengirim")!=null): ?><?php echo e(set_value("nohp_pengirim")); ?><?php endif; ?>" required>
						...
						<div class="col-md-3">
							...
							<select class="form-control <?php if(form_error('kec_pengirim')!=null): ?> is-invalid <?php endif; ?>" id="kec_pengirim" name="kec_pengirim" required></select>
						...
						<div class="col-md-3">
							...
							<input type="number" step="any" minlength="11" maxlength="13" placeholder="masukan telp penerima"  class="form-control <?php if(form_error('nohp_penerima')!=null): ?> is-invalid <?php endif; ?>" id="nohp_penerima" name="nohp_penerima" value="<?php if(set_value("nohp_penerima")!=null): ?><?php echo e(set_value("nohp_penerima")); ?><?php endif; ?>" required>
						...
						<div class="col-md-3">
							...
							<select class="form-control <?php if(form_error('kec_penerima')!=null): ?> is-invalid <?php endif; ?>" id="kec_penerima" name="kec_penerima" required></select>
						...
						<div class="col-md-3">
							...
							<div class="input-group">
								<input type="number" id="harga_lain" name="harga_lain" maxlength="30"  class="form-control <?php if(form_error('harga_lain')!=null): ?> is-invalid <?php endif; ?>" value="<?php if(set_value("harga_lain")!=null): ?><?php echo e(set_value("harga_lain")); ?><?php endif; ?>"  required step="any">
								<div class="input-group-prepend" >
									<span class="input-group-text">Rp.</span>
								</div>
							</div>
						...
						<div class="col-md-6">
							...
							<table class="table table-responsive">
								<tr>
									<td width="20%">
										<label><input type="radio" value="1" id="c_hitung" name="c_hitung" required> Berat</label>
									</td>
									<td width="20%">
										<label><input type="radio" value="2" id="c_hitung" name="c_hitung" required> KgV</label>
									</td>
									<td width="20%">
										<label><input type="radio" value="3" id="c_hitung" name="c_hitung" required> Kubik (M3)</label>
									</td>
									<td width="20%">
						...
						<div class="col-md-3">
							...
							<div class="input-group">
								<input type="number" readonly="readonly" id="n_minimal" name="n_minimal" maxlength="30"  class="form-control <?php if(form_error('n_minimal')!=null): ?> is-invalid <?php endif; ?>" step="any" required placeholder="50" value="<?php if(set_value("n_minimal")!=null): ?><?php echo e(set_value("n_minimal")); ?><?php endif; ?>">
								<div class="input-group-prepend">
									<span class="input-group-text">Kg</span>
								</div>
							</div>
			...
			<div class="tab-pane" id="kt_tab_pane_2_4" role="tabpanel" aria-labelledby="kt_tab_pane_2_4">
			...
			<div class="tab-pane" id="kt_tab_pane_3_4" role="tabpanel" aria-labelledby="kt_tab_pane_2_4">
				<table class="table table-hover table-responsive"> 
					<thead class="thead-dark">
						<tr>
							<th>No. </th>
			...
			<div class="tab-pane" id="kt_tab_pane_4_4" role="tabpanel" aria-labelledby="kt_tab_pane_3_4">
...
</script><?php /**PATH D:\xampp\htdocs\aplikasi-booking-lsj\application\views/metronic/showdetail.blade.php ENDPATH**/ ?>