	...
	<div class="card-header card-header-tabs-line">
		...
		<div class="card-toolbar">
			<div class="text-right">
				<?php if(get_instance()->uri->segment(1) == 'pickup'): ?>
				<button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fa fa-print"></i> Cetak Laporan Pickup</button>
				<?php endif; ?>
				...
				<div class="mb-7">
					<div class="row align-items-center">
						<div class="col-lg-12 col-xl-12">
							<div class="row align-items-center">
								<?php echo $__env->make("metronic.filter.filter-pickup", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title tex-center">Cetak Laporan Pickup</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<form action="<?php echo base_url() ?>laporan/laporan_pdf" method="post">
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<input type="date" class="form-control" name="dr_tgl" id="f_dr_tgl" >
							</div>
							...
							<div class="col-md-6">
								...
								<input type="date" class="form-control" name="sp_tgl" id="f_sp_tgl" >
							</div>
						</div>
						<br>
					</div>
...
<?php echo $__env->make("metronic.pickup/js-pickup", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make("metronic.js-notifikasi", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make("metronic.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\aplikasi-booking-lsj\application\views/metronic/pickup/pickup.blade.php ENDPATH**/ ?>